...
def classification_map_cv2(map, ground_truth, dpi, save_path):
    fig = plt.figure(frameon=False)
    fig.set_size_inches(ground_truth.shape[1]*2.0/dpi, ground_truth.shape[0]*2.0/dpi)
...
def get_cls_map(net, device, all_data_loader, y, folder_name):
    ...
    classification_map(y_re, y, 300,
                       folder_name + 'predictions.png')
    classification_map(gt_re, y, 300,
                       folder_name + 'gt.png')

    classification_map_cv2(y_re, y, 300,
                       folder_name + 'predictions_cv2.png')
    classification_map_cv2(gt_re, y, 300,
                       folder_name + 'gt_cv2.png')
